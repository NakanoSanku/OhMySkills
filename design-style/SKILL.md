---
name: design-style
description: Use this skill when the user asks to build a frontend interface, web page, or UI component. Automatically retrieves the appropriate design system prompt from the prompts directory to help create visually distinctive, production-grade frontend code with specific design styles like Neo-brutalism, Modern Dark, Bauhaus, etc.
